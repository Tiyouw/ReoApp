...
export const icons = {
  ...
  grip: icon(<><circle cx="9" cy="6" r="1" fill="currentColor"/><circle cx="15" cy="6" r="1" fill="currentColor"/><circle cx="9" cy="12" r="1" fill="currentColor"/><circle cx="15" cy="12" r="1" fill="currentColor"/><circle cx="9" cy="18" r="1" fill="currentColor"/><circle cx="15" cy="18" r="1" fill="currentColor"/></>, 14),
  ...
  bellOff: icon(<><path d="M8.7 3A6 6 0 0 1 18 8c0 2.7.7 4.5 1.3 5.7"/><path d="M3 3l18 18"/><path d="M10.3 21a1.94 1.94 0 0 0 3.4 0"/><path d="M17 17H3s3-2 3-9a4.67 4.67 0 0 1 .3-1.7"/></>),
